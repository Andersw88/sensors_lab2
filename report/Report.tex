...
\maketitle
\begin{center}
  \emph{All code for this exercise can be found at \\ \url{https://github.com/Andersw88/sensors_lab2}}
\end{center}
\tableofcontents
\listoffigures
\vspace{20mm}
...
\begin{figure}[h!tbp]
  \centering
  \includegraphics[width=.7\textwidth]{checkers-uncalibrated.png}
  \caption{Uncalibrated checkers board image}
  \label{fig:checkers_board_uncalibrated}
\end{figure}
\begin{figure}[h!tbp]
  \centering
  \includegraphics[width=.7\textwidth]{checkers-calibrated.png}
