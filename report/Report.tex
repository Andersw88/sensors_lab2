...
\label{sec:color_camera_calibration}
%TODO!

\subsection{Noise Characterization}
\label{sec:noize_characterization}
...
\label{sec:nan_statement}
If objects in the scene are closer than the minimum range of the camera allows 
