...
In this part the color camera was calibrated using a checkers board print. The checkers board. %TODO
\par
The improvement of the calibrated picture isn't qantitavely measurable with the tools at hand, so the verification has to be carried out with judgement by the naked eye. Still, the difference is barely visible, which can be explained by the low correction values. %TODO
